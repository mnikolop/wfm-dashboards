...
def localities_def():
    ...
    # Loads and creates localities data.
    # Prerequisites: Localities file to be loaded in the warehouse.
...
def costCenters_def(size = 500, start = 1111):

    # Creates CostCenter data.
