...
customerContracts.to_csv('4-Local-filesystem/data-out/d_customerContracts.csv')  
...
companies_list = pd.read_csv('4-Local-filesystem/ranges/companiesList.csv')
...
customers.to_csv('4-Local-filesystem/data-out/d_customers.csv')  
