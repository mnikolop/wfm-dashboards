...
employeeContracts.to_csv('4-Local-filesystem/data-out/d_employeeContracts.csv')  
...
locality_structures = pd.read_csv('4-Local-filesystem/data-out/d_localities.csv')

# COMMAND ----------

names = pd.read_csv('4-Local-filesystem/ranges/Names.csv')
...
employees.to_csv('4-Local-filesystem/data-out/d_employees.csv')