...
costCenters = pd.read_csv('4-Local-filesystem/data-out/d_costCenters.csv')

# COMMAND ----------

employees = pd.read_csv('4-Local-filesystem/data-out/d_employees.csv')

# COMMAND ----------

employeeContracts = pd.read_csv('4-Local-filesystem/data-out/d_employeecontracts.csv')


# COMMAND ----------

localities = employeeContracts = pd.read_csv('4-Local-filesystem/data-out/d_localities.csv')


# COMMAND ----------

customers = employeeContracts = pd.read_csv('4-Local-filesystem/data-out/d_customers.csv')


# COMMAND ----------

employeeScedules = employeeContracts = pd.read_csv('4-Local-filesystem/data-out/d_employeeScedules.csv')
...
shifts.to_csv('4-Local-filesystem/data-out/d_shifts.csv')  
...
f_shifts.to_csv('4-Local-filesystem/data-out/f_shifts.csv')  
